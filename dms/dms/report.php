                  ...
                  <div class="col-lg-12">
					...
					if($query->num_rows > 0){
						...
						<tr>
                            ...
                            <a href="report_edit.php?idNo=<?php echo $rows['idNo']; ?>&active=report">Edit</a>
                              <a href="report_delete.php?idNo=<?php echo $rows['idNo']; ?>" onclick="return confirm('Are you sure to Remove this')">Remove</a>
                            </td>
						</tr>
						<?php
						$sl++;
