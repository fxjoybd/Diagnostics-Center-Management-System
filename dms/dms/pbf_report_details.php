...
<?php
	...
	//if($addResult){
		$getResult = $mysqli->query("select * from pbf_result join invoice on pbf_result.idNo = invoice.idNo where pbf_result.idNo = '$_GET[idNo]'");
		$metaArray = $getResult->fetch_array();
		?>
        <div class="btn" align="center"><button onclick="window.print()" style="padding:3px 15px; font-weight:bold">Print</button><button onclick="window.location='pbf_report.php?active=pbf'" style="padding:3px 15px; font-weight:bold">Back</button></div>
        <div id="main_page">
        ...
        <tr>
            ...
            <td valign="top" style="border-right:1px solid; border-top:1px solid" align="right">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td align="right"><?php echo $metaArray['patientAge']; ?> Years</td>
                </tr>
                <tr>
                	<td align="right">
	                    Sex &nbsp;&nbsp;
        ...
        <tr>
        	<td colspan="2" style="padding-top:50px">
                <?php
                $getData1 = $mysqli->query("select * from pbf_result where idNo = '$metaArray[idNo]'");
