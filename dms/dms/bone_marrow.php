...
::placeholder { /* Most modern browsers support this now. */
   color: #666;
      ...
      <section id="main-content">
        ...
        <div class="row">
        	<div class="col-lg-4">
            	<input autoComplete="off" type="text" class="input-control" id="idNo" name="idNo" placeholder="ID No">
            </div>
            <div class="col-lg-4">    
                <input autoComplete="off" type="text" class="input-control" id="boneMarrow" name="boneMarrow" placeholder="Bone Marrow">
            </div>
            <div class="col-lg-4">        
			...
			if(isset($_GET['idNo']) && $_GET['idNo'] <> ''){
                ...
                <?php $boneMarrow = $_GET['boneMarrow']; ?>
                        <iframe name="richTextField" src="br.php?data=<?php echo $boneMarrow; ?>" id="editor" style="width: 1000px; height: 500px; border: 1px solid #999"></iframe>
                <form action="add_bone_marrow_result.php" method="post">
