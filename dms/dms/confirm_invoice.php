...
<?php
	...
	$query = $mysqli->query("insert into invoice values('', '$labDailySl', '$is_path', '$createNewId', '$refdId', '$coId', '$convertPN', '$sex', '$ageDetails', '$mobile', '$totalAmount', '$is_due', '0', '$date', '$time', '$deli_time', '$userFullName')") or die($mysqli->error);
		...
		$pathQuery = $mysqli->query("select * from invoice where invoiceId = '$getInvoiceId'");
                    	...
                    	<td colspan="5" style="padding-bottom:10px">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td align="center" valign="top"><font style="font-size:18px; font-weight:bold"><b>BANGLADESH DIAGNOSTIC & CONSULTATION CENTRE</b></font><br />
                ...
                <div id="invoice_<?php echo $isl0; ?>">
                    	...
                    	<td colspan="5" style="padding-bottom:10px">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" width="100">&nbsp;</td>
                                    <td align="center" valign="top"><b>BANGLADESH DIAGNOSTIC & CONSULTATION CENTRE</b></font><br />
                                    <font style="font-size:12px">Dhap(Medical More), Jail Road, Rangpur.<br />Mob: 01735-240270</font></td>
                                    <td valign="top" align="center">
                                    <font style="font-size:16px; font-weight:bold">Cash Receipt</font><br />
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top" width="450px">
                                        <font style="font-size:18px; font-weight:bold"><b>BANGLADESH DIAGNOSTIC & CONSULTATION CENTRE</b></font>
                                    </td>
