...
<?php
	...
	//$mysqli->query("insert into bone_marrow_result values('', '$_POST[boneMarrowId]', '$_POST[idNo]', '$_POST[labNo]', '$_POST[content]', '$date', '$time')");

	$mysqli-> query("update bone_marrow_result set labNo = '$_POST[labNo]', boneMarrow = '$_POST[boneMarrow]', content = '$_POST[boneMarrowContent]' where idNo = '$_POST[idNo]'");
	...
	//if($addResult){
		...
		?>
        <div class="btn" align="center"><button onclick="window.print()" style="padding:3px 15px; font-weight:bold">Print</button><button onclick="window.location='bone_marrow_report.php?active=bone_marrow'" style="padding:3px 15px; font-weight:bold">Back</button></div>
        <div id="main_page">
