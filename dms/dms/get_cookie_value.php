        ...
        foreach ($getIndex as $key1 => $value1) {
            if(is_array($value1)){
                foreach ($value1 as $key2 => $value2) {
                    ...
                    $activeValue = $key1.$key2;
                ?>
                    <li <?php if(isset($_GET['active']) && $_GET['active'] == $activeValue){ echo 'class="active"';} ?>><a class="t" onclick="active('<?php echo $convertPN ?>', '<?php echo $key2 ?>')" data-toggle="tab" href="#<?php echo $activeId; ?>"><?php echo $convertPN; ?></a><span class="m" style="display: none;"><?php echo $key2; ?></span></li>
                <?php
                    $active = "";
                    $activeId++;
                }
    ...
    foreach ($getIndex as $key1 => $value1) {
        if(is_array($value1)){
            foreach ($value1 as $key2 => $value2) {
                ...
                $mainIndex = $key1.'/'.$key2;
            ?>
                <div id="<?php echo $activeId; ?>" class="tab-pane fade <?php if(isset($_GET['active']) && $_GET['active'] == $activeValue){ echo 'in active';} ?>">
