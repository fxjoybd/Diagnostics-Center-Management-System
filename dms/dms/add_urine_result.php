...
<?php
	...
	$mysqli->query("insert into urine values('', '$_POST[idNo]', '$_POST[colour]', '$_POST[quantity]', '$_POST[appearance]', '$_POST[sediment]', '$_POST[reaction]', '$_POST[albumin]', '$_POST[sugar]', '$_POST[excessPhosphate]', '$_POST[bileSalt]', '$_POST[bilePigment]', '$_POST[urobilinogen]', '$_POST[ketoneBodies]', '$_POST[benceJonesProtein]', '$epithelialCells', '$plusCells', '$_POST[rbc1]', '$_POST[rbc2]', '$_POST[wbc]', '$_POST[epithelial]', '$_POST[granular]', '$_POST[hyaline]', '$_POST[calOxalate]', '$_POST[amorPhos]', '$_POST[triplePhos]', '$_POST[sulphonamide]', '$_POST[sricAcid]', '$_POST[urates]', '$_POST[parasites]', '$_POST[spermatozoa]', '$_POST[trichomonas]', '$_POST[yeast]', '$_POST[note]', '$date', '$time')") or die($mysqli->error);
	...
	//if($addResult){
		...
		?>
        <div class="btn" align="center"><button onclick="window.print()" style="padding:3px 15px; font-weight:bold">Print</button><button onclick="window.location='urine.php?active=urine'" style="padding:3px 15px; font-weight:bold">Back</button></div>
        <div id="main_page">
