...
$update = $mysqli->query("update cash_back set isCancel = '1' where invoiceId = '$_GET[invoiceId]'");

$update = $mysqli->query("update write_off set isCancel = '1' where invoiceId = '$_GET[invoiceId]'");
