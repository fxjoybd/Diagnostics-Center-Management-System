...
function discountPer(index){
	...
	var calDueAmount = calTotalAmount - (parseFloat(payment) + parseFloat(paid));
          ...
          <div class="row">
          	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="margin-bottom:2px">
	        	<div class="input-group">
	                ...
	                <input type="text" class="input-control" onfocus="this.select();" placeholder="Patient Name" id="patientName" style="color:#000" name="patientName" autoComplete="off">
	            </div>
	        </div>
	        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-bottom:2px">
	        	<div class="input-group">
	                <span class="input-group-addon"><i class="fa fa-phone"></i></span>
	                <input type="text" class="input-control" onfocus="this.select();" placeholder="Phone Number" id="mobile" style="color:#000" name="mobile" autoComplete="off">
	            </div>
	        </div>
	        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="margin-bottom:2px">
	        	<div class="input-group">
	                <span class="input-group-addon"><i class="fa fa-stethoscope"></i></span>
	                <input type="text" class="input-control" placeholder="Search Test" id="searchTest" autoComplete="off"><span class="input-group-addon loading_test" style="display:none"><img src="img/broken_circle.gif" width="18" height="18" /></span>
	            </div>
	        </div>
          </div>
          <div class="row">
