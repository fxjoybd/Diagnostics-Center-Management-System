          ...
          <section class="wrapper">            
            ...
            <div class="row">
				<div class="col-lg-12">
                    ...
                    <tbody>
                    <?php
					$query = $mysqli->query("select * from doctor order by id asc");
					if($query->num_rows > 0){
						$sl = 1;
						...
						<tr>
							...
							<td align="center"><a href="edit_doctor.php?active=doctor&doctorId=<?php echo $rows['id']; ?>">Edit</a>&nbsp;&nbsp;<a href="delete_doctor.php?doctorId=<?php echo $rows['id']; ?>" onClick="return confirm('Are you sure want to delete?')">Delete</a></td>
						</tr>
						<?php
						$sl++;
						}
