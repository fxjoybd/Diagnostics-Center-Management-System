...
function load_perpage(perpage, page, searchByDate){
	window.location = 'print_due_report.php?perpage='+perpage+'&page='+page+searchByDate;
}
    ...
    <div class="receipt">
        ...
        <table border="0" width="90%" cellspacing="0" style="font-size:12px">
          <tr>
                ...
                <th style="border:1px solid; border-left:none; font-style:italic">Paid</th>
        ...
        <tr style="font-weight:bold">
            ...
            <td style="border:1px solid; border-top:none; border-left:none; text-align:center"><?php echo sprintf('%.2f',$totalPay); ?></td>
            <td style="border:1px solid; border-top:none; border-left:none; text-align:center"><?php echo sprintf('%.2f',$totalDue); ?></td>
