                ...
                <div id="invoice_<?php echo $invoiceSl; ?>">
                        ...
                        <td colspan="5" style="padding-bottom:10px">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" width="100"><img src="img/Take Care Lab.JPG" width="100" height="100" /></td>
                                    <td align="center" valign="top"><font style="font-size:18px; font-weight:bold">BANGLADESH DIAGNOSTIC CENTRE</font><br />
                                    <font style="font-size:12px">Dhap(Medical More), Jail Road, Rangpur.<br />Mob: 01735-240270</font></td>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding:2px">
                                        ...
                                        <tr>
                                            ...
                                            <td width="150px" align="right" style="border-top:1px solid">
                                                <?php
                                                    $totalDue = ceil($totalAmount) - $payArray[0];
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding:2px">
                                        ...
                                        <tr>
                                            ...
                                            <td width="150px" align="right" style="border-top:1px solid">
                                                <?php
                                                    $totalDue = ceil($netTotal - $payArray[0]);
                                                    echo sprintf('%.2f',$totalDue);
                                                ?>
                                            </td>
                                        </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top" width="450px">
                                        <font style="font-size:18px; font-weight:bold">BANGLADESH DIAGNOSTIC CENTRE</font>
                                    </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td valign="top" align="right">
                                <font style="font-size:16px; font-weight:bold">Lab ID No: <?php echo $array['pathDailySl']; ?><br/><u>Pathology</u></font>
                            </td>
                        </tr>
                    </table>
                </td>
